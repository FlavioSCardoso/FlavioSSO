...
namespace Flavio.SSO.Client.SecurityService {
    ...
    public partial class UserViewModel : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Flavio.SSO.Client.SecurityService.GroupViewModel[] GroupsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Flavio.SSO.Client.SecurityService.GroupViewModel[] Groups {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="SecurityService.IUserService")]
    public interface IUserService {
        ...
        Flavio.SSO.Client.SecurityService.UserViewModel AuthenticateUser(string userName, string password);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUserService/AuthenticateUser", ReplyAction="http://tempuri.org/IUserService/AuthenticateUserResponse")]
        System.Threading.Tasks.Task<Flavio.SSO.Client.SecurityService.UserViewModel> AuthenticateUserAsync(string userName, string password);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUserService/GetAuthenticateUserByToken", ReplyAction="http://tempuri.org/IUserService/GetAuthenticateUserByTokenResponse")]
        Flavio.SSO.Client.SecurityService.UserViewModel GetAuthenticateUserByToken(string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUserService/GetAuthenticateUserByToken", ReplyAction="http://tempuri.org/IUserService/GetAuthenticateUserByTokenResponse")]
        System.Threading.Tasks.Task<Flavio.SSO.Client.SecurityService.UserViewModel> GetAuthenticateUserByTokenAsync(string token);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IUserServiceChannel : Flavio.SSO.Client.SecurityService.IUserService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UserServiceClient : System.ServiceModel.ClientBase<Flavio.SSO.Client.SecurityService.IUserService>, Flavio.SSO.Client.SecurityService.IUserService {
        ...
        public Flavio.SSO.Client.SecurityService.UserViewModel AuthenticateUser(string userName, string password) {
            return base.Channel.AuthenticateUser(userName, password);
        }
        
        public System.Threading.Tasks.Task<Flavio.SSO.Client.SecurityService.UserViewModel> AuthenticateUserAsync(string userName, string password) {
            return base.Channel.AuthenticateUserAsync(userName, password);
        }
        
        public Flavio.SSO.Client.SecurityService.UserViewModel GetAuthenticateUserByToken(string token) {
            return base.Channel.GetAuthenticateUserByToken(token);
        }
        
        public System.Threading.Tasks.Task<Flavio.SSO.Client.SecurityService.UserViewModel> GetAuthenticateUserByTokenAsync(string token) {
            return base.Channel.GetAuthenticateUserByTokenAsync(token);
        }
